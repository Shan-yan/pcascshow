...
below it, while a manuscript-grounded, two-row dome gallery fills the right side
with independently focusable station-scene crops and a central annotation line.
...
exploring / 开始探索” control. Selecting it expands five large morphing bubble
destinations across the section. Detailed benchmark overviews and paper
