      ...
      <section className="section section--orbit home-section--orbit" data-reveal="up">
        <div className="container">
          <SectionHeading
            ...
            description="300 standardized instances, six evaluated MLLMs and a human study with more than 50 respondents: 51 questionnaires were received and 49 participants met the eligibility criteria."
          />
