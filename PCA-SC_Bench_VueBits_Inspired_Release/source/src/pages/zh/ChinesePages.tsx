...
import { EvolutionFlow, OrbitExplorer, SplitTitle } from "../../components/LandingExperience";
    ...
    <>
      <section className="hero">
        <div className="container hero__grid">
          ...
          <div className="system-map" data-reveal="right" aria-label="PCA-SC 评测逻辑">
      ...
      <section className="section section--soft" data-reveal="up">
      ...
      <section className="section section--orbit" data-reveal="up">
        <div className="container">
      ...
      <section className="section">
        <div className="container">
          <SectionHeading eyebrow="03 · 基准概览" title="论文已确认的数据规模" />
      ...
      <section className="section section--ink">
        <div className="container">
          <SectionHeading eyebrow="04 · 论文主要发现" title="多指标结果与人类授权判断" />
