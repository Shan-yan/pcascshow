...
The landing page now opens with the benchmark name, its Chinese academic
subtitle, and an explicit P/C/A/S/C acronym legend. The next section animates
the transition from task-success-only evaluation to public-space safety and
PCA-SC diagnosis. A rotating benchmark explorer presents 300 instances, six
models and the human-study sample, then expands five navigation destinations
from a central “Start exploring / 开始探索” control.
