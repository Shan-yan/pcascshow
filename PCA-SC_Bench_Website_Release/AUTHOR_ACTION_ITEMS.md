...
- [ ] Add the final manuscript file to the project and audit all visible facts
      against it. The requested paper DOCX was not present in the workspace.
...
- [ ] Final participant and expert counts
- [ ] Recruitment, compensation and exclusion details
- [ ] Ethics approval, exemption or committee identifier
- [ ] Missing-data and withdrawal procedures
- [ ] Final human-validity results, correlations, agreement and uncertainty
- [ ] Confirm whether the protocol targets of 120 cases, approximately 150
      public participants and 8 experts remain current
