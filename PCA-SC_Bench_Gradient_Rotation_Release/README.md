...
The enlarged landing page keeps `PCA-SC Bench` on one expressive line and makes the benchmark name, Chinese academic subtitle
...
component for all six model portraits, plus route-entry transitions, animated
numeric counters and an interactive five-dimension focus strip. Radar axes remain on the reported 0–1
