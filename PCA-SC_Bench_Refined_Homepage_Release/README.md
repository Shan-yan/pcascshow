...
below it, while a manuscript-grounded four-scene case preview replaces the old
evaluation-flow card. The next section animates the transition from
task-success-only evaluation to public-space safety and PCA-SC diagnosis. A
rotating benchmark explorer presents 300 instances, six models and the human
study, then expands five borderless circular-text destinations from a luminous
“Start exploring / 开始探索” control. Detailed benchmark overviews and paper
...
in React and CSS with no added animation dependency. All effects respect
