import { AcademicBadge, SectionHeading } from "../components/UI";
...
export function Home() {
  return (
    <>
          ...
          <div className="hero__copy" data-reveal="up">
            ...
            <div className="hero__supporting-copy">
              ...
              <p className="hero__description">
                ...
                separately, complemented by a human study with 49 eligible participants.
              </p>
            </div>
            <div className="button-row">
              <a className="button button--primary" href="#/paper"><Icon name="file" /> Paper</a>
              <a className="button button--secondary" href="#/dataset">Explore Dataset</a>
      ...
      <section className="section section--rule home-section--motivation" data-reveal="up">
      ...
      <section className="section section--orbit home-section--orbit" data-reveal="up">
        <div className="container">
          <SectionHeading
            ...
            description="300 standardized instances, six evaluated MLLMs and a human study with more than 50 respondents."
          />
      ...
      <section className="section home-section--next">
        <div className="container next-step">
          <div><p className="eyebrow">Next step</p><h2>Inspect the complete multi-metric profiles of six models</h2></div>
          <a className="button button--primary" href="#/models">View evaluation results <Icon name="arrow" /></a>
        </div>
      </section>
    </>
  );
