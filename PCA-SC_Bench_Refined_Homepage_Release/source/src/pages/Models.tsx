  ...
  return (
    <>
        ...
        <div className="container">
          ...
          {visibleModels.length === 0 ? (
            ...
            <div className="profile-chart" role="figure" aria-label="Grouped horizontal bars comparing P, C, A and Safety across selected models">
              ...
              <p className="chart-caption">Figure view · Aggregate scores over 300 instances · Source: manuscript Table 1</p>
            </div>
          ) : (
      ...
      <section className="section">
        <div className="container">
          <SectionHeading
            eyebrow="06 · Human-centered evidence"
