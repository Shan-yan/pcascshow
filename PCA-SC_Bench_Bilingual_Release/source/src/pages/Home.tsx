  ...
  return (
    <>
        ...
        <div className="container">
          ...
          <div className="motivation-flow">
            <div className="motivation-step">
              ...
              <h3>Was the task completed?</h3>
              <p>A single completion measure can hide how the outcome was reached.</p>
            </div>
            <div className="motivation-arrow"><Icon name="arrow" size={22} /></div>
            <div className="motivation-step motivation-step--gap">
              <span>Public-space gap</span>
              <h3>Was the action acceptable?</h3>
              <p>A successful action can still ignore a safety gate, crowd or public rule.</p>
            </div>
            <div className="motivation-arrow"><Icon name="arrow" size={22} /></div>
            <div className="motivation-step motivation-step--response">
              <span>PCA-SC response</span>
              <h3>Where did the chain break?</h3>
              <p>Separate success, safety and evidence-grounded P–C–A consistency.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="section section--soft">
        <div className="container">
          <SectionHeading
            eyebrow="02 · Benchmark at a glance"
      ...
      <section className="section section--ink">
        <div className="container">
          <SectionHeading
            eyebrow="04 · Evaluation framework"
      ...
      <section className="section section--soft">
        <div className="container split-heading">
          <div>
            <p className="eyebrow">06 · Scope first</p>
